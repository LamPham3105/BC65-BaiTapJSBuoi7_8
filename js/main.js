...
getElementID("hanldSumPositiveNumber").onclick = function() {
    ...
    getElement("#sumPositiveNumber").innerHTML = getResult(result);
}
...
getElementID("hanldCountPositiveNumber").onclick = function() {
    ...
    getElement("#countPositiveNumber").innerHTML = getResult(result);
}
...
getElementID("hanldFindMinNumber").onclick = function() {
    ...
    getElement("#minNumber").innerHTML = getResult(result);
}
...
getElementID("hanldFindMinPositiveNumber").onclick = function() {
    ...
    if (arrNumberInput.length <= 0) {
        ...
        if (arrPositiveNumber.length <= 0) {
            ...
            var minPositiveNumber = arrPositiveNumber[findIndexMin(arrPositiveNumber)];
            result = `Số dương nhỏ nhất trong mảng là ${minPositiveNumber}`;
        }
    }
    
    getElement("#minPositiveNumber").innerHTML = getResult(result);
}
...
getElementID("hanldFindLastEven").onclick = function() {
    ...
    getElement("#lastEven").innerHTML = getResult(result);
}
...
getElementID("hanldSwapNumber").onclick = function() {
    ...
    if (arrNumberInput.length <= 0) {
        result = "Mảng không có giá trị";
    } else if (isNaN(positionSwapOne) || isNaN(positionSwapTwo)) {
        result = "Vị trí chỉ có thể là số dương >= 0";
    } else if (positionSwapOne > arrNumberInput.length - 1 || positionSwapTwo > arrNumberInput.length - 1) {
        result = "Vị trí nhập không nằm trong mảng";
    } else {
        var arrSwap = swapElements(arrNumberInput, positionSwapOne, positionSwapTwo);
    ...
    getElement("#swapResult").innerHTML = getResult(result);
}
...
getElementID("hanldArrangeIncrease").onclick = function() {
    ...
    getElement("#increaseArray").innerHTML = getResult(result);
}
...
getElementID("hanldFirstPrime").onclick = function() {
    ...
    getElement("#firstPrime").innerHTML = getResult(result);
}
...
getElementID("hanldCountInteger").onclick = function() { 
    ...
    getElement("#countIntegerResult").innerHTML = getResult(result);
}

//----------------- So sánh số lượng số dương và số âm -----------------------//
function getCountNumber(arr) {
    var countNegativeNumber = 0, countPositiveNumber = 0;
...
getElementID("hanldCompare").onclick = function() {
    var countNegativeNumber, countPositiveNumber,result;
    ...
    getElement("#compareResult").innerHTML = getResult(result);
}